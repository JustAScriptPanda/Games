...
do
	...
	function library:Notify(title, text, callback)
		...
		notification.Accept.TouchTap:Connect(function()
		...
		notification.Decline.TouchTap:Connect(function()
	...
	function section:addToggle(title, default, callback)
		...
		toggle.TouchTap:Connect(onClick)
	...
	function section:addTextbox(title, default, callback)
		...
		textbox.MouseButton1Click:Connect(onClick)
		textbox.TouchTap:Connect(onClick)
	...
	function section:addKeybind(title, default, callback, changedCallback)
		...
		keybind.MouseButton1Click:Connect(onClick)
		keybind.TouchTap:Connect(onClick)
	...
	function section:addColorPicker(title, default, callback)
		...
		canvas.MouseButton1Down:Connect(canvasDrag)
		canvas.TouchTap:Connect(canvasDrag)
		
		local colorDrag = function()
			draggingColor = true
			...
			while draggingColor do
				...
				if inputPos ~= Vector2.new(0, 0) then
					...
					hue = 1 - math.clamp(1 - ((mouseX - colorPosition.X) / colorSize.X), 0, 1)
					color3 = Color3.fromHSV(hue, sat, brightness)
		...
		color.MouseButton1Down:Connect(colorDrag)
		color.TouchTap:Connect(colorDrag)
		...
		button.TouchTap:Connect(toggleTab)
		colorpicker.MouseButton1Click:Connect(toggleTab)
		colorpicker.TouchTap:Connect(toggleTab)
		
		tab.Container.Button.MouseButton1Click:Connect(function()
			animate()
		end)
		
		tab.Container.Button.TouchTap:Connect(function()
			animate()
		end)
		...
		tab.Close.TouchTap:Connect(function()
			self:updateColorPicker(colorpicker, nil, lastColor)
			animate()
		end)
	...
	function section:addSlider(title, default, min, max, callback)
		...
		slider.MouseButton1Down:Connect(onDrag)
		slider.TouchTap:Connect(onDrag)
	...
	function section:addDropdown(title, list, callback)
		...
		search.Button.MouseButton1Click:Connect(onButtonClick)
		search.Button.TouchTap:Connect(onButtonClick)
